<main id="main">
    <div class="container" style="padding-top: 30px">
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',['slug'=>$lproduct->slug])}}" title="{{$lproduct->name}}">
                                            <figure><img src="{{ asset('assets/images/products/') }}/{{$lproduct->image}}" style="width: 220px; height: 220px; object-fit: cover" alt="{{$lproduct->name}}"></figure>
                                        </a>
                                        <div class="group-flash">
                                            <span style="margin-top: 10px" class="flash-item new-label success">new</span>
                                        </div>
                                    </div>
                                    <div class="product-info">
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                @foreach ($lessthanproducts as $lessthanproduct)
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{route('product.details',['slug'=>$lessthanproduct->slug])}}" title="{{$lessthanproduct->name}}">
                            <figure><img style="width: 220px; height: 220px; object-fit: cover" src="{{ asset('assets/images/products/') }}\{{$lessthanproduct->image}}" width="800" height="800" alt="{{$lessthanproduct->name}}"></figure>
                        </a>
                        <div class="group-flash">
                            <span style="margin-top: 10px" class="flash-item sale-label">sale</span>
                        </div>
                    ...
                    <div class="product-info">
                        <a href="{{route('product.details',['slug'=>$lessthanproduct->slug])}}" class="product-name"><span>{{$lessthanproduct->name}}</span></a>
                        <div class="wrap-price"><span class="product-price">₱{{$lessthanproduct->regular_price}}</span></div>
                    </div>
                </div>
                @endforeach
            </div>
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{route('product.details',['slug'=>$c_product->slug])}}" title="{{$c_product->name}}">
                                                <figure><img src="{{ asset('assets/images/products/') }}\{{$c_product->image}}" style="width: 220px; height: 220px; object-fit: cover" alt="{{$c_product->name}}"></figure>
                                            </a>
                                            <div class="group-flash">
