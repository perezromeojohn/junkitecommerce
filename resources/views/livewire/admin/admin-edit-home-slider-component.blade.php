                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateSlide">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Title" class="form-control input-md" required wire:model="title" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="localhost:8000/shop" class="form-control input-md" wire:model="link" required />
                                </div>
                            </div>
                            <div class="form-group">
